...
/* -------------------  TM4C123GH6PM Specific Interrupt Numbers  ------------------ */
  Dio_Port_A_IRQn                    =   0,              /*!<   0  Dio_Port_A                                                            */
  Dio_Port_B_IRQn                    =   1,              /*!<   1  Dio_Port_B                                                            */
  Dio_Port_C_IRQn                    =   2,              /*!<   2  Dio_Port_C                                                            */
  Dio_Port_D_IRQn                    =   3,              /*!<   3  Dio_Port_D                                                            */
  Dio_Port_E_IRQn                    =   4,              /*!<   4  Dio_Port_E                                                            */
  ...
  Dio_Port_F_IRQn                    =  30,              /*!<  30  Dio_Port_F                                                            */
...
/**
  * @brief Register map for Dio_Port_A peripheral (Dio_Port_A)
  */

typedef struct {                                    /*!< Dio_Port_A Structure                                                       */
...
#define Dio_Port_A_BASE                      0x40004000UL
#define Dio_Port_B_BASE                      0x40005000UL
#define Dio_Port_C_BASE                      0x40006000UL
#define Dio_Port_D_BASE                      0x40007000UL
...
#define Dio_Port_E_BASE                      0x40024000UL
#define Dio_Port_F_BASE                      0x40025000UL
...
#define Dio_Port_A_AHB_BASE                  0x40058000UL
#define Dio_Port_B_AHB_BASE                  0x40059000UL
#define Dio_Port_C_AHB_BASE                  0x4005A000UL
#define Dio_Port_D_AHB_BASE                  0x4005B000UL
#define Dio_Port_E_AHB_BASE                  0x4005C000UL
#define Dio_Port_F_AHB_BASE                  0x4005D000UL
...
#define Dio_Port_A                           ((Dio_PortType              *) Dio_Port_A_BASE)
#define Dio_Port_B                           ((Dio_PortType              *) Dio_Port_B_BASE)
#define Dio_Port_C                           ((Dio_PortType              *) Dio_Port_C_BASE)
#define Dio_Port_D                           ((Dio_PortType              *) Dio_Port_D_BASE)
...
#define Dio_Port_E                           ((Dio_PortType              *) Dio_Port_E_BASE)
#define Dio_Port_F                           ((Dio_PortType              *) Dio_Port_F_BASE)
...
#define Dio_Port_A_AHB                       ((Dio_PortType              *) Dio_Port_A_AHB_BASE)
#define Dio_Port_B_AHB                       ((Dio_PortType              *) Dio_Port_B_AHB_BASE)
#define Dio_Port_C_AHB                       ((Dio_PortType              *) Dio_Port_C_AHB_BASE)
#define Dio_Port_D_AHB                       ((Dio_PortType              *) Dio_Port_D_AHB_BASE)
#define Dio_Port_E_AHB                       ((Dio_PortType              *) Dio_Port_E_AHB_BASE)
#define Dio_Port_F_AHB                       ((Dio_PortType              *) Dio_Port_F_AHB_BASE)
