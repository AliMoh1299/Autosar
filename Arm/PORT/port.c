...
uint32 Delay;
 Port_ConfigType const Config[] = {
	/*----------------------------------------------------------------------------------------------------*/
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PA0
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PA1 
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PA2
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PA3
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PA4
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PA5
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PA6
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PA7
/*----------------------------------------------------------------------------------------------------*/
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PB0
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PB1
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PB2
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PB3
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PB4
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PB5
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PB6
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PB7
/*----------------------------------------------------------------------------------------------------*/
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PC0
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PC1
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PC2
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PC3
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PC4
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PC5
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PC6
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PC7
/*----------------------------------------------------------------------------------------------------*/
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PD0
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PD1
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PD2
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PD3
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PD4
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PD5
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PD6
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PD7
/*----------------------------------------------------------------------------------------------------*/
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PE0
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PE1
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PE2
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PE3
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PE4
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PE5
/*----------------------------------------------------------------------------------------------------*/
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PF0
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PF1
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PF2
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}, // PF3
{DEN_ON,UNLOCKED,CR_ON,AFSEL_OFF,AMSEL_OFF,PCTL_OFF,DIR_OUTPUT,ADC_OFF}  // PF4
/*----------------------------------------------------------------------------------------------------*/
};
 ...
 if( PinCounter >=0  && PinCounter <=7  )
	{
	  ...
	  if(ConfigPtr->LOCK_R==UNLOCKED)			{GPIOA->LOCK=UNLOCK_CODE;}
		...
		if(ConfigPtr->ADCCTL_R==ADC_OFF)    {CLR_BIT(GPIOA->ADCCTL,(PinCounter-PORTA_START));}
		else                                {SET_BIT(GPIOA->ADCCTL,(PinCounter-PORTA_START));}		
	...
	else if( PinCounter >=8  && PinCounter <=15  )
	{
	  ...
	  if(ConfigPtr->LOCK_R==UNLOCKED)			{GPIOB->LOCK=UNLOCK_CODE;}
		...
		if(ConfigPtr->ADCCTL_R==ADC_OFF)    {CLR_BIT(GPIOB->ADCCTL,(PinCounter-PORTB_START));}
		else                                {SET_BIT(GPIOB->ADCCTL,(PinCounter-PORTB_START));}
	...
	/*		{ 			 SET_BIT(SYSCTL->RCGC2,2);	
	  ...
	  if(ConfigPtr->LOCK_R==UNLOCKED)			{GPIOC->LOCK=UNLOCK_CODE;}
		...
		if(ConfigPtr->ADCCTL_R==ADC_OFF)    {CLR_BIT(GPIOC->ADCCTL,(PinCounter-PORTC_START));}
		else                                {SET_BIT(GPIOC->ADCCTL,(PinCounter-PORTC_START));}
	...
	*/
	else if( PinCounter >=24  && PinCounter <=31  )
	{
	  ...
	  if(ConfigPtr->LOCK_R==UNLOCKED)			{GPIOD->LOCK=UNLOCK_CODE;}
		...
		if(ConfigPtr->ADCCTL_R==ADC_OFF)    {CLR_BIT(GPIOD->ADCCTL,(PinCounter-PORTD_START));}
		else                                {SET_BIT(GPIOD->ADCCTL,(PinCounter-PORTD_START));}
	...
	else if( PinCounter >=32  && PinCounter <=37  )
	{
	  ...
	  if(ConfigPtr->LOCK_R==UNLOCKED)			{GPIOE->LOCK=UNLOCK_CODE;}
		...
		if(ConfigPtr->ADCCTL_R==ADC_OFF)    {CLR_BIT(GPIOE->ADCCTL,(PinCounter-PORTE_START));}
		else                                {SET_BIT(GPIOE->ADCCTL,(PinCounter-PORTE_START));}
  ...
  else if( PinCounter >=38  && PinCounter <=43  )
	{
	  ...
	  if(ConfigPtr->LOCK_R==UNLOCKED)			{GPIOF->LOCK=UNLOCK_CODE;}
		...
		if(ConfigPtr->ADCCTL_R==ADC_OFF)    {CLR_BIT(GPIOF->ADCCTL,(PinCounter-PORTF_START));}
		else                                {SET_BIT(GPIOF->ADCCTL,(PinCounter-PORTF_START));}
